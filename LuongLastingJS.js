...
function calcServicesAndCosts() {
    // equalTo() method returns items equal to the specified key or value
    var database_ref = database.ref("artists/" + addArtist().artistID).child("responses/" + saveResponsev1().responseID).equalTo("nonBrideMakeup", "nonBrideHair", "nonBrideHairSetting", "nonBrideHairStyling", "children", "brideMakeup", "brideHair", "brideHairSetting", "brideHairStyling", "nonWeddingMakeup", "nonWeddingHair", "nonWeddingHairSetting", "nonWeddingHairStyling")
    ...
    var database_ref2 = database.ref("artists/" + addArtist().artistID).equalTo("nonBride_makeup_pay", "nonBride_hair_pay", "nonBride_hair_setting_pay", "nonBride_hair_styling_pay", "children_pay", "bride_makeup_pay", "bride_hair_pay", "bride_hair_setting_pay", "bride_hair_styling_pay", "nonWedding_makeup_pay", "nonWedding_hair_pay", "nonWedding_hair_setting_pay", "nonWedding_hair_styling_pay")
